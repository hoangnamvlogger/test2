...
<div id="warning">
    <div id="message">
        ...
        <h4 style="text-align: center;">The content of this site may contain adult content and/or photographs that not
            acceptable for the people who not under 16 years old. Please click on the link below to verify that you are
            at least 16 years of age and consent to viewing adult content.</h4>
        <div id="warning-left"><h3 style="text-align: right;"><a href="#" id="enterSite">Continue to view this site</a>
        </h3></div>
        <div id="warning-right"><h3 style="text-align:left; padding-left: 10px;"><a href="#" id="closeSite">No, I'm not
            under 16 years old</a></h3></div>
