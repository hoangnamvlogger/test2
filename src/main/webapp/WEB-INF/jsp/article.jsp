...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${rootUrl}" style="margin-left: 45px;">SexyCowGirlPhotos</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="${categoryName eq 'asian' ? 'active' : ''}"><a href="${rootUrl}category/asian">Asian</a></li>
                <li class="${categoryName eq 'boobs' ? 'active' : ''}"><a href="${rootUrl}category/boobs">Boobs</a></li>
                <li class="${categoryName eq 'bikini' ? 'active' : ''}"><a href="${rootUrl}category/bikini">Bikini</a>
                </li>
                <li class="${categoryName eq 'find her' ? 'active' : ''}"><a href="${rootUrl}category/find her">Find
                    Her</a></li>
                <li class="${categoryName eq 'hot women' ? 'active' : ''}"><a href="${rootUrl}category/hot women">Hot
                    Women</a></li>
                <li class="${categoryName eq 'cute' ? 'active' : ''}"><a href="${rootUrl}category/cute">Cute</a></li>
                <li class="${categoryName eq 'teen' ? 'active' : ''}"><a href="${rootUrl}category/teen">Teen</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
            ...
            <div class="main-grids">
                <div class="top-grids">
                    <div class="recommended-info">
                        <h1 title="${articles.title}" img="${articles.thumbnail}" id="articleTitle">${articles.title}</h1>
                        <!-- AddToAny BEGIN -->
                    ...
                    <c:forEach items="${articles.links}" var="articleDetail" varStatus="theCount">
                        <div class="col-md-12 resent-grid recommended-grid slider-top-grids">
                            <div class="resent-grid-img recommended-grid-img">
                                <a href="${rootUrl}${article.href}" class="post-url" articleId="${article.id}"><img src="${linkImage}${articleDetail.img}" alt=""/></a>
                            </div>
            ...
            <div class="main-grids">
                <div class="top-grids">
                    ...
                    <c:forEach items="${mostviewed}" var="mostviewed" varStatus="theCount">
                        <div class="col-md-6 resent-grid recommended-grid slider-top-grids">
                            <div class="resent-grid-img recommended-grid-img">
                                <a href="${rootUrl}${mostviewed.href}" class="post-url" articleId="${mostviewed.id}"><img src="${linkRootImage}${mostviewed.thumbnail}" alt=""/></a>
                            </div>
                            <div class="resent-grid-info recommended-grid-info">
                                <h3>
                                    <a href="${rootUrl}${mostviewed.href}" articleId="${mostviewed.id}" class="title title-info post-url">${mostviewed.title}</a>
                                </h3>
                            </div>
                        </div>
                ...
                <div class="top-grids" style="margin-top:15px;">
                    ...
                    <c:forEach items="${newestphoto}" var="newestphoto" varStatus="theCount">
                        <div class="col-md-6 resent-grid recommended-grid slider-top-grids">
                            <div class="resent-grid-img recommended-grid-img">
                                <a href="${rootUrl}${newestphoto.href}" class="post-url" articleId="${newestphoto.id}"><img src="${linkRootImage}${newestphoto.thumbnail}" alt=""/></a>
                            </div>
                            <div class="resent-grid-info recommended-grid-info">
                                <h3>
                                    <a href="${rootUrl}${newestphoto.href}" articleId="${newestphoto.id}" class="title title-info post-url">${newestphoto.title}</a>
                                </h3>
                            </div>
                        </div>
                        <c:if test="${theCount.count % 2 == 0 && theCount.count > 0}">
                ...
                <div class="top-grids" style="margin-top:15px;">
                    ...
                    <c:forEach items="${randomPhoto}" var="randomPhoto" varStatus="theCount">
                        <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                            <div class="resent-grid-img recommended-grid-img">
                                <a href="${rootUrl}${randomPhoto.href}" class="post-url" articleId="${randomPhoto.id}"><img src="${linkRootImage}${randomPhoto.thumbnail}" alt=""/></a>
                            </div>
                            <div class="resent-grid-info recommended-grid-info">
                                <h3>
                                    <a href="${rootUrl}${randomPhoto.href}" articleId="${randomPhoto.id}" class="title title-info post-url">${randomPhoto.title}</a>
                                </h3>
                            </div>
                        </div>
