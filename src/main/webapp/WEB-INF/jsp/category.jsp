    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="main-grids">
                <div class="top-grids">
                    <c:forEach items="${articlesByCategoryId}" var="article" varStatus="theCount">
                        <div class="col-md-6 resent-grid recommended-grid slider-top-grids">
                            <div class="resent-grid-img recommended-grid-img">
                                <a href="${rootUrl}${article.href}" class="post-url" articleId="${article.id}"><img src="${linkImage}${article.thumbnail}" alt=""/></a>
                            </div>
