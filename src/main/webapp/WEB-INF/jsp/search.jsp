            ...
            <div class="main-grids">
                <div class="top-grids">
                    <div class="recommended-info">
                        <c:choose>
                            <c:when test="${null == results || results.size() == 0}">
                    ...
                    <c:forEach items="${results}" var="article" varStatus="theCount">
                        <div class="col-md-6 resent-grid recommended-grid slider-top-grids">
                            <div class="resent-grid-img recommended-grid-img">
                                <a href="${rootlUr}${article.href}" class="post-url" articleId="${article.id}"><img src="${linkImage}${article.thumbnail}" alt=""/></a>
                            </div>
                            <div class="resent-grid-info recommended-grid-info">
                                <h3>
                                    <a href="${rootlUr}${article.href}" articleId="${article.id}" class="title title-info post-url">${article.title}</a>
                                </h3>
                            </div>
                        </div>
